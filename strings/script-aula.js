...
listaFrutas.includes(fruta, 14); // false, começa a procurar apartir do index 14
...
transacao1.slice(-4); // ente, vaor negativo pega os ultimos caracteres(de tras pra frente)
